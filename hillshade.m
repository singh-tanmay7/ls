...
% We used We used the hillshade function from Hebeler (2007). Furthermore, two more explanations were discussed as below:
% 1) We fill the resolution value of images and DTM. For example, The parameters, "dx" and "dy", were 
%    substituted 5 if the resolution value of images and DTM was 5 m. For the same reason, 
%    "dx" and "dy" were replaced by 15 if the resolution value of images and DTM was 15 m.
% 2) The mark, %, was showed at the head of this demand since we did not compile the demand, "h=setborder(h,1,NaN)", in the program.
%
% -----------------------------------References----------------------------------------
